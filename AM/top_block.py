...
# Title: Top Block
# Generated: Tue May 15 12:20:11 2018
##################################################
...
class top_block(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.Input_Gain = Input_Gain = 6

        ##################################################
        # Blocks
        ##################################################
        self._Input_Gain_range = Range(0, 20, 0.01, 6, 200)
        self._Input_Gain_win = RangeWidget(self._Input_Gain_range, self.set_Input_Gain, "Input Gain/Modulation Index", "slider", float)
        ...
        self.low_pass_filter_0 = filter.interp_fir_filter_fff(1, firdes.low_pass(
        	1, samp_rate, 50000, 10000, firdes.WIN_HAMMING, 6.76))
        self.blocks_wavfile_source_0 = blocks.wavfile_source("/home/acrylonitrile/Documents/ravenfiltered", True)
        self.blocks_throttle_3 = blocks.throttle(gr.sizeof_float*1, 44100,True)
        ...
        self.blocks_multiply_const_vxx_1 = blocks.multiply_const_vff((0.06, ))
        self.blocks_multiply_const_vxx_0 = blocks.multiply_const_vff((Input_Gain, ))
        self.blocks_add_const_vxx_1 = blocks.add_const_vff((-5.33, ))
        self.blocks_add_const_vxx_0 = blocks.add_const_vff((2, ))
        self.blocks_abs_xx_0 = blocks.abs_ff(1)
        self.audio_sink_0 = audio.sink(44100, "", True)
        self.analog_sig_source_x_0 = analog.sig_source_f(300000, analog.GR_COS_WAVE, 1000000, 4, 0)
        ...
        self.connect((self.blocks_multiply_const_vxx_1, 0), (self.rational_resampler_xxx_2, 0))    
        ...
        self.connect((self.blocks_throttle_3, 0), (self.qtgui_freq_sink_x_0_1, 0))    
        self.connect((self.blocks_throttle_3, 0), (self.qtgui_time_sink_x_0_1, 0))    
        ...
        self.connect((self.rational_resampler_xxx_2, 0), (self.blocks_throttle_3, 0))    
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.low_pass_filter_0.set_taps(firdes.low_pass(1, self.samp_rate, 50000, 10000, firdes.WIN_HAMMING, 6.76))
